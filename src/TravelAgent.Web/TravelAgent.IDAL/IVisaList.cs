...
namespace TravelAgent.IDAL
{
    public interface IVisaList
    {
       ...
       int GetMaxID(string FieldName);
        ...
        /// 增加一条数据
        /// </summary>
        void Add(TravelAgent.Model.VisaList model);
        /// <summary>
        /// 修改一条数据
        /// </summary>
        ...
        /// 更新一条数据
        /// </summary>
        void Update(TravelAgent.Model.VisaList model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        void Delete(int Id);
        ...
        /// 得到一个对象实体
        /// </summary>
        TravelAgent.Model.VisaList GetModel(int Id);
        /// <summary>
        /// 获得前几行数据
        /// </summary>
