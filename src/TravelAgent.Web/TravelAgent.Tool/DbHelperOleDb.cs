...
namespace TravelAgent.Tool
{
    ...
    public abstract class DbHelperOleDb
    {
        ...
        public static string connectionString = ConfigurationManager.ConnectionStrings["ConnectionAccessString"].ConnectionString.ToString() + HttpContext.Current.Server.MapPath(ConfigurationManager.AppSettings["DbAccessPath"]) + ";";
