...
jQuery.imageMagnify={
	...
	cursorcss: 'url(), -moz-zoom-in', //Value for CSS's 'cursor' attribute, added to original image
	zIndexcounter: 100,
	...
	refreshoffsets:function($window, $target, warpshell){
		...
		warpshell.newattrs.x=winattrs.x+winattrs.w/3-warpshell.newattrs.w/2
		warpshell.newattrs.y=winattrs.y+winattrs.h/3-warpshell.newattrs.h/2
