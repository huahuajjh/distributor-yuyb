...
using System.IO;
using TravelAgent.Web.UI;

namespace TravelAgent.Web.Tools
{
    /// <summary>
    /// $codebehindclassname$ 的摘要说明
    /// </summary>
    public class SingleUpload1 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //    return;
            //}
            HttpPostedFile _upfile = context.Request.Files["FileUpload1"];
            string _delfile = context.Request.Params["txtImgUrl1"];
            if (_upfile == null)
            {
