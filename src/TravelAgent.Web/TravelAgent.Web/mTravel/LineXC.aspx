<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineXC.aspx.cs" Inherits="TravelAgent.Web.mTravel.LineXC" %>

<html>
        <head>
                <meta charset="utf-8" />
                <title><%=Line.LineName %>行程参考-<%=webinfo.WebName %></title>                
                <meta name="viewport" id="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
                <link rel="stylesheet" type="text/css" href="/mTravel/css/mobile-style.css" />
		<link rel="stylesheet" type="text/css" href="/mTravel/css/mobile-line.css" />
