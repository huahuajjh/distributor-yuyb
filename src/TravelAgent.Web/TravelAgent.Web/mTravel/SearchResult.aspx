<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchResult.aspx.cs" Inherits="TravelAgent.Web.mTravel.SearchResult" %>
...
<html>
        <head>
                <meta charset="utf-8" />
                <title><%=key %>的搜索结果-<%=webinfo.WebName %></title>
