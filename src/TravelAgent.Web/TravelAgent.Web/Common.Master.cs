    ...
    public partial class Common : System.Web.UI.MasterPage
    {
        ...
        public string BindDest()
        {
            ...
            else
            {
                ...
                for (int i = 1; i <= fristLength; i++)
                {
                    ...
                    double dblMiddle = Convert.ToDouble(TwoRows_Length) / 2;
                    ...
                    for (int h = 0; h <= middle - 1; h++)
                    {
                        ...
                        //urlrewrite
                        strDest.Append("<h4 class=\"subItem-hd\"><a href=\"/linemodel/" + FristRows[i - 1]["Id"] + "_" + TwoRows[h]["Id"] + ".html\" target=\"_blank\">" + TwoRows[h]["navName"] + "</a></h4>");
        ...
        public string BindRongyu()
        {
            ...
            foreach (DataRow row in dsRongyu.Tables[0].Rows)
            {
                ...
                sbRongyu.Append("<a href=\"" + row["LinkUrl"] + "\"><img src=\"" + row["AdUrl"] + "\" alt=\"" + row["Title"] + "\"></a>");
            }
