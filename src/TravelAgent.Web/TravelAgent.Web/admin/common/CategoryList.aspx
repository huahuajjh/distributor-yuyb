<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryList.aspx.cs" Inherits="TravelAgent.Web.admin.common.CategoryList" %>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(".category_delete").unbind();
        $(".category_delete").click(function() {
            var id = $(this).attr("id");
            var name = $(this).attr("name");
            art.dialog.confirm("确认删除内容分类[ " + name + " ]及子分类吗？", function() {
                $.ajax({
                    type: "POST",
                    url: "../data/Common.aspx",
                    cache: false,
                    dataType: "text",
                    data: { tag: "category_delete", categoryid: id },
...
<body>
    ...
    <div class="tools">
    	...
    	<%--<ul class="toolbar">
        <li class="click"><a href="EditCategory.aspx" class="category_art" title="添加内容分类" width="700px" height="380px"><span><img src="../images/t01.png" /></span>添加内容分类</a></li>
        </ul>
    --%>
    <%=ShowAdd() %>
    </div>
