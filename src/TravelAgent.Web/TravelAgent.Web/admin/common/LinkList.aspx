<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkList.aspx.cs" Inherits="TravelAgent.Web.admin.common.LinkList" %>
        ...
        <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <td style="text-align:center"><%# Eval("WebUrl")%></td>
                    <td style="text-align:center"><%# Eval("SortId")%></td>
                    <td style="text-align:center"><%# Eval("IsLock").ToString().Equals("0")?"隐藏":"显示"%></td>
