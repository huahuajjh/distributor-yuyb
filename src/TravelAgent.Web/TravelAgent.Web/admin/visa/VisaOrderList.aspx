<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisaOrderList.aspx.cs" Inherits="TravelAgent.Web.admin.visa.VisaOrderList" %>
...
<script type="text/javascript">
    $(function() {
            ...
            $("#Pagination").pagination(<%=pcount %>, {
	            ...
	            current_page:<%=page %>,
	            num_edge_entries:2,
	            link_to:"?<%=CombUrlTxt(this.strordercode, this.strordername, this.strorderstartdate, this.strorderenddate, this.orderstate, this.clubid) %>page=__id__"
           });
...
<body>
    ...
    <div class="tools">
        <ul class="toolbar">
            ...
            <div class="cityleft">
                ...
                <div class="cityleft" style=" padding-top:7px;">签证名称:</div>
            <div class="cityleft">
   ...
   <asp:DropDownList ID="ddlState" runat="server" CssClass="select1">
    ...
    <div class="tools" style=" background-color:#f9f0a8; padding-top:15px; padding-left:20px;">快捷查询：
        <asp:HyperLink ID="hljrorder" runat="server">今日下单</asp:HyperLink>  
            <asp:HyperLink ID="hlbzorder" runat="server">本周下单</asp:HyperLink>  
            <asp:HyperLink ID="hlbyorder" runat="server">本月下单</asp:HyperLink>
            ...
            <ItemTemplate>
                 <tr>
                   ...
                   <td><%# Eval("ordercode")%></td>
                    ...
                    <td style="text-align:center"><%# Eval("peopleNumber")%></td>
                    <td><a href="/visa/VisaDetail.aspx?id=<%# Eval("lineId")%>" target="_blank" class="tablelink"><%# Eval("visaName")%></a></td>
                    <td style="text-align:center"><%# Eval("orderPrice")%></td>
                    ...
                    <td><%# Eval("contactName")%><br /><%# Eval("contactMobile")%><br /><%# Eval("contactEmail")%></td>
