<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VistTypeList.aspx.cs" Inherits="TravelAgent.Web.admin.visa.VistTypeList" %>
...
<script type="text/javascript">
    $(function() {
        ...
        $(".type_delete").click(function() {
            ...
            art.dialog.confirm("确认删除签证类型[ " + name + " ]吗？", function() {
                $.ajax({
                    type: "POST",
                    url: "../data/Visa.aspx",
                    cache: false,
                    dataType: "text",
                    data: { tag: "type_delete", typeid: id },
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><a href="EditVisaType.aspx" class="type_art" title="添加签证类型" width="600px" height="250px"><span><img src="../images/t01.png" /></span>添加签证类型</a></li>
        </ul>
        ...
        <table class="tablelist">
                ...
                <tbody id="AllNav">
        <asp:Repeater ID="rptVisaType" runat="server">
        <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align:center"><%# ShowEdit(Eval("Id").ToString(), Eval("Name").ToString())%></td>
                </tr> 
        </ItemTemplate>
        </asp:Repeater>
