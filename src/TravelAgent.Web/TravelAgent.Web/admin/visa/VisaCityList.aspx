<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisaCityList.aspx.cs" Inherits="TravelAgent.Web.admin.visa.VisaCityList" %>
...
<script type="text/javascript">
    $(function() {
        ...
        $(".city_delete").click(function() {
            ...
            art.dialog.confirm("确认删除领区城市[ " + name + " ]吗？", function() {
                $.ajax({
                    type: "POST",
                    url: "../data/Visa.aspx",
                    cache: false,
...
<body>
    ...
    <div class="tools">
    	...
    	<%--<ul class="toolbar">
        <li class="click"><a href="EditVisaCity.aspx" class="city_art" title="添加领区" width="600px" height="350px"><span><img src="../images/t01.png" /></span>添加领区</a></li>
        </ul>--%>
     <%=ShowAdd() %>
    </div>
