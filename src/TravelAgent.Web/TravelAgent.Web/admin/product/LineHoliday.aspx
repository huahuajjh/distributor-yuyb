<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LineHoliday.aspx.cs" Inherits="TravelAgent.Web.admin.product.LineHoliday" %>
...
<script type="text/javascript">
    $(function() {
        ...
        $(".theme_delete").click(function() {
            ...
            art.dialog.confirm("确认删除节日[ " + name + " ]吗？", function() {
                $.ajax({
                    type: "POST",
                    url: "../data/Product_Holiday.aspx",
                    cache: false,
                    dataType: "text",
                    data: { tag: "holiday_delete", holidayid: id },
    ...
    <div class="tools">
        ...
        <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align:center"><%# ShowEdit(Eval("Id").ToString(), Eval("holidayName").ToString())%></td>
                </tr> 
        </ItemTemplate>
        </asp:Repeater>
