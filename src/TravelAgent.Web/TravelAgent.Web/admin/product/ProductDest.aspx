<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductDest.aspx.cs" Inherits="TravelAgent.Web.admin.product.ProductDest" %>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $(".dest_delete").unbind();
        $(".dest_delete").click(function() {
            var id = $(this).attr("id");
            var name = $(this).attr("name");
            art.dialog.confirm("确认删除目的地[ " + name + " ]吗？", function() {
                $.ajax({
                    type: "POST",
                    url: "../data/Product_Line.aspx",
                    cache: false,
                    dataType: "text",
                    data: { tag: "dest_delete", destid: id },
...
<body>
   ...
   <li><a href="#">产品管理</a></li>
    ...
    <div class="tools">
    	...
    	<%--<ul class="toolbar">
        <li class="click"><a href="EditDest.aspx" class="dest_art" title="添加旅游目的地" width="700px" height="380px"><span><img src="../images/t01.png" /></span>添加目的地</a></li>
        </ul>--%>
        <%=ShowAdd()%>
        ...
        <table class="tablelist">
                ...
                <th style="width:16%">目的地名称</th>
                <th>目的地链接</th>
                <th style="width:17%">目的地状态</th>
