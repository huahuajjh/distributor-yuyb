<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditLineOrder.aspx.cs" Inherits="TravelAgent.Web.admin.product.EditLineOrder" %>
            ...
            $("#btnSave").click(function() {
                ...
                if(confirm("确认操作该订单吗？"))
                {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        dataType: "text",
                        data: { orderid: <%=orderid %>, subprice: $("#txtJiaJian").val(),usepoints:$("#txtuserPoints").val(),donatepoints:$("#hddonate").val(),orderstate:$("#ddlState").val(),oprremark:$("#txtRemark").val(),paytype:$("#ddlPayType").val(),ordercode:$("#hdordercode").val(),clubid:$("#hdclubid").val() },
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="formtable">
            ...
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5;  width:15%;">线路名称 ：</td>
                <td colspan="3">
            ...
            <tr>
                ...
                <td style="text-align:right; color:#056dae;background: #F5F5F5;  width:18%;">人数（成人/儿童）：</td>
                <td>
            ...
            <tr>
                ...
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">出游日期：</td>
                <td>
            ...
            <tr>
             ...
             <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">推荐人(WAP) ：</td>
                <td>
                    <asp:Label ID="lbltuijianren" runat="server" Text=""></asp:Label>
                </td>
                
            </tr>
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">身份证号 ：</td>
                <td>
                    <asp:Label ID="IDcard" runat="server" Text=""></asp:Label>
                </td>
                
            </tr>
            <tr>
                <td style="text-align:right; color:#056dae;" colspan="4">
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%; text-align:center" class="formtable">
                        <tr>
                              <td style=" background:#F5F5F5;">姓名</td>
                              <td style=" background:#F5F5F5;">性别</td>
                              <td style=" background:#F5F5F5;">证件类型</td>
                              <td style=" background:#F5F5F5;">证件号</td>
            ...
            <tr>
                ...
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">
                    加减额：</td>
                <td>
                    <input id="txtJiaJian" name="txtJiaJian" type="text" class="dfinput" style="width:60px" /> 元</td>
            </tr>
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">是否买保险：</td>
                <td>
                    <asp:Label ID="lblIsBaoxian" runat="server" Text=""></asp:Label>
                </td>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">
                    保险费用：</td>
                <td>
                    <asp:Label ID="lblBaoxianCost" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">
                    应付总金额：</td>
                <td>
                    <asp:Label ID="lblPayCost" runat="server" Text="" Font-Bold="true" ForeColor="Red"></asp:Label>元，(订单金额+保险费用-积分使用+加减价)
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">
                    操作备注：</td>
                <td>
                    <textarea id="txtRemark" cols="40" name="txtRemark" rows="4" style=" border:1px solid #000; width:150px"  runat="server"></textarea></td>
            </tr>
            <tr>
    ...
    <asp:HiddenField ID="hdclubid" runat="server" />
    </form>
</body>
</html>
