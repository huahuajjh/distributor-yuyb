<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCity.aspx.cs" Inherits="TravelAgent.Web.admin.product.EditCity" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditNav = function() {
            ...
            $(this).val("正在保存中...");
            var options = {
                url: "../data/Product_Line.aspx?tag=city_save&date=" + new Date().toUTCString(),
                type: 'POST',
