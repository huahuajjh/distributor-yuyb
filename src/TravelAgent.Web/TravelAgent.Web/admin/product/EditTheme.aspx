<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTheme.aspx.cs" Inherits="TravelAgent.Web.admin.product.EditTheme" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditNav = function() {
            ...
            $(this).val("正在保存中...");
            var options = {
                url: "../data/Product_Line.aspx?tag=theme_save&date=" + new Date().toUTCString(),
                type: 'POST',
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="formtable">
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">主题名称 <span class="red">*</span>：</td>
            ...
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; "> 主题背景<span class="red">*</span>：</td>
                <td style=" padding-top:10px;">
                    ...
                    <span><br />
                        格式仅限JPG|JPEG|PNG|GIF，推荐像素1920*550</span>
                </td>
            </tr>
            <tr>
