<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCarOrder.aspx.cs" Inherits="TravelAgent.Web.admin.car.EditCarOrder" %>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="formtable">
            ...
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5;  width:15%;">租车名称 ：</td>
                <td colspan="3">
            ...
            <tr>
                ...
                <td style="text-align:right; color:#056dae;background: #F5F5F5;  width:18%;">用车数量：</td>
                <td>
                    <asp:Label ID="lblUseCount" runat="server" Text=""></asp:Label> 辆
                </td>
            </tr>
            <tr>
                ...
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">租车类型：</td>
                <td>
                    <asp:Label ID="lblCarType" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">用车日期：</td>
                <td>
                ...
                <td>
                    <asp:Label ID="lblHuanDate" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
