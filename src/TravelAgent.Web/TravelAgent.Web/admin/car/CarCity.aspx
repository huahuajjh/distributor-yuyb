<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarCity.aspx.cs" Inherits="TravelAgent.Web.admin.car.CarCity" %>
        ...
        $(".city_delete").click(function() {
            ...
            art.dialog.confirm("确认删除租车城市[ " + name + " ]吗？", function() {
                $.ajax({
                    ...
                    cache: false,
                    dataType: "text",
                    data: { tag: "city_delete", cityid: id },
    ...
    <div class="tools">
        ...
        <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align:center"><%# ShowEdit(Eval("Id").ToString(), Eval("CityName").ToString())%></td>
                </tr> 
        </ItemTemplate>
        </asp:Repeater>
