<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarClass.aspx.cs" Inherits="TravelAgent.Web.admin.car.CarClass" %>
...
<script type="text/javascript">
    $(function() {
        ...
        $(".city_delete").click(function() {
            ...
            art.dialog.confirm("确认删除租车城市[ " + name + " ]吗？", function() {
                $.ajax({
                    type: "POST",
                    url: "../data/card/CarData.aspx",
                    cache: false,
                    dataType: "text",
                    data: { tag: "class_delete", classid: id },
...
<body>
    ...
    <div class="tools">
    	...
    	<%--<ul class="toolbar">
        <li class="click"><a href="EditCity.aspx" class="city_art" title="添加出发城市" width="600px" height="250px"><span><img src="../images/t01.png" /></span>添加出发城市</a></li>
        </ul>--%>
        <%=ShowAdd()%>
    </div>
        ...
        <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align:center"><%# ShowEdit(Eval("Id").ToString(), Eval("ClassName").ToString())%></td>
                </tr> 
        </ItemTemplate>
        </asp:Repeater>
