<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarNumber.aspx.cs" Inherits="TravelAgent.Web.admin.car.CarNumber" %>
...
<script type="text/javascript">
    $(function() {
        ...
        $(".city_delete").click(function() {
            ...
            art.dialog.confirm("确认删除汽车厢数[ " + name + " ]吗？", function() {
                $.ajax({
                    type: "POST",
                    url: "../data/card/CarData.aspx",
                    cache: false,
                    dataType: "text",
                    data: { tag: "num_delete", numid: id },
    ...
    <div class="tools">
        ...
        <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align:center"><%# ShowEdit(Eval("Id").ToString(), Eval("NumName").ToString())%></td>
                </tr> 
        </ItemTemplate>
        </asp:Repeater>
