<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCarNumber.aspx.cs" Inherits="TravelAgent.Web.admin.car.EditCarNumber" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditNav = function() {
            ...
            $(this).val("正在保存中...");
            var options = {
                url: "../data/card/CarData.aspx?tag=num_save&date=" + new Date().toUTCString(),
                type: 'POST',
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="formtable">
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">车厢名称 <span class="red">*</span>：</td>
                <td><asp:TextBox ID="txtNumName" runat="server" CssClass="dfinput required" MaxLength="25" Width="200px"></asp:TextBox>
