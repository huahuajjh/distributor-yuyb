...
{
    public partial class CarNumber : TravelAgent.Web.UI.BasePage
    {
        private static readonly TravelAgent.BLL.CarNumber Bll = new TravelAgent.BLL.CarNumber();
        ...
        public string ShowAdd()
        {
            ...
            if (Admin.Role.roleAuth.IndexOf(",linecity_add,") > -1)
            {
                ...
                sbButton.Append("<li class=\"click\"><a href=\"EditCarNumber.aspx\" class=\"city_art\" title=\"添加汽车厢数\" width=\"600px\" height=\"250px\"><span><img src=\"../images/t01.png\" /></span>添加汽车厢数</a></li>");
                sbButton.Append("</ul>");
            }
        ...
        public string ShowEdit(string id, string title)
        {
            ...
            {
                sbEdit.Append("<a href=\"EditCarNumber.aspx?numid=" + id + "\" class=\"tablelink city_art\" width=\"600px\" height=\"250px\">修改</a>  ");
            }
