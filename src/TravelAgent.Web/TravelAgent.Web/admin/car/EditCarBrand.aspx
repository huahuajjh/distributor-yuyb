<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCarBrand.aspx.cs" Inherits="TravelAgent.Web.admin.car.EditCarBrand" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditNav = function() {
            ...
            $(this).val("正在保存中...");
            var options = {
                url: "../data/card/CarData.aspx?tag=brand_save&date=" + new Date().toUTCString(),
                type: 'POST',
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="formtable">
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">品牌名称 <span class="red">*</span>：</td>
                <td><asp:TextBox ID="txtBrandName" runat="server" CssClass="dfinput required" MaxLength="25" Width="200px"></asp:TextBox>
                        <span>至少1个字符，小于25个字符。</span>
                </td>
            </tr>
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; "> 
                    品牌LOGO<span class="red">*</span>：</td>
