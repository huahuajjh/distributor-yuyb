...
{
    public partial class CarCity : TravelAgent.Web.UI.BasePage
    {
        ...
        public string ShowAdd()
        {
            ...
            if (Admin.Role.roleAuth.IndexOf(",linecity_add,") > -1)
            {
                ...
                sbButton.Append("<li class=\"click\"><a href=\"EditCarCity.aspx\" class=\"city_art\" title=\"添加租车城市\" width=\"600px\" height=\"250px\"><span><img src=\"../images/t01.png\" /></span>添加租车城市</a></li>");
                sbButton.Append("</ul>");
            }
        ...
        public string ShowEdit(string id, string title)
        {
            ...
            {
                sbEdit.Append("<a href=\"EditCarCity.aspx?cityid=" + id + "\" class=\"tablelink city_art\" width=\"600px\" height=\"250px\">修改</a>  ");
            }
