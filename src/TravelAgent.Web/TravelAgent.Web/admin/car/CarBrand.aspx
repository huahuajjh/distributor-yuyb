<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarBrand.aspx.cs" Inherits="TravelAgent.Web.admin.car.CarBrand" %>
...
<script type="text/javascript">
    $(function() {
        ...
        $(".theme_delete").click(function() {
            ...
            art.dialog.confirm("确认删除租车品牌[ " + name + " ]吗？", function() {
                $.ajax({
                    type: "POST",
    ...
    <div class="tools">
        ...
        <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align:center"><img src="<%# Eval("BrandPic")%>" style="width:60px; height:60px;" /></td>
                    <td style="text-align:center"><%# Eval("Sort")%></td>
                    <td style="text-align:center"><%# ShowEdit(Eval("Id").ToString(), Eval("BrandName").ToString())%></td>
                </tr> 
        </ItemTemplate>
        </asp:Repeater>
