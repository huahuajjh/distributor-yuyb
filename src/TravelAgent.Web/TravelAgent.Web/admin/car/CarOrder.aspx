<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarOrder.aspx.cs" Inherits="TravelAgent.Web.admin.car.CarOrder" %>
...
<body>
    ...
    <div class="tools">
        <ul class="toolbar">
            ...
            <div class="cityleft">
                ...
                <div class="cityleft" style=" padding-top:7px;">租车名称:</div>
            <div class="cityleft">
   ...
   <asp:DropDownList ID="ddlState" runat="server" CssClass="select1">
    ...
    <table class="tablelist">
        ...
        <th style="width:8%">用车日期</th>
        <th style="width:8%">用车数量</th>
        <th style="width:22%">租车详细</th>
        ...
        <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <td><%# Eval("usedate")%></td>
                    <td style="text-align:center"><%# Eval("account")%></td>
                    <td><a href="/car/CarDetail.aspx?id=<%# Eval("lineId")%>" target="_blank" class="tablelink"><%# Eval("CarName")%></a>-<%#ShowCarPrice(Convert.ToInt32(Eval("peopleNumber")))%></td>
