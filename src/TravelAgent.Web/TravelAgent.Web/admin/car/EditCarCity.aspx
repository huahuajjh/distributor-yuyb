<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCarCity.aspx.cs" Inherits="TravelAgent.Web.admin.car.EditCarCity" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditNav = function() {
            ...
            $(this).val("正在保存中...");
            var options = {
                url: "../data/card/CarData.aspx?tag=city_save&date=" + new Date().toUTCString(),
                type: 'POST',
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="formtable">
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">出发城市 <span class="red">*</span>：</td>
                <td><asp:TextBox ID="txtCityName" runat="server" CssClass="dfinput required" MaxLength="25" Width="200px"></asp:TextBox>
