<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBrand.aspx.cs" Inherits="TravelAgent.Web.admin.basicset.EditBrand" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var EditNav = function() {
            ...
            $(this).val("正在保存中...");
            var options = {
                url: "../data/Common.aspx?tag=brand_save&date=" + new Date().toUTCString(),
                type: 'POST',
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;" class="formtable">
             <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">类型 <span class="red">*</span>：</td>
                <td style=" padding-top:10px;padding-left:15px">
                    <asp:DropDownList ID="ddlType" runat="server" CssClass="required">
                        <asp:ListItem Value="">选择位置</asp:ListItem>
                        <asp:ListItem Value="0">首页</asp:ListItem>
                        <asp:ListItem Value="1">签证</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">标题 <span class="red">*</span>：</td>
                <td><asp:TextBox ID="txtTitle" runat="server" CssClass="dfinput required" MaxLength="15" Width="180px"></asp:TextBox>
                        <span>至少1个字符，小于15个字符。</span>
                </td>
            </tr>
            <tr>
                <td style="text-align:right; color:#056dae;background: #F5F5F5; ">副标题 <span class="red">*</span>：</td>
                <td><asp:TextBox ID="txtSubTitle" runat="server" CssClass="dfinput required" MaxLength="50" Width="300px"></asp:TextBox>
